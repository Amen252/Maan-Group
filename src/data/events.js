export const eventsData = [
    {
        id: 1,
        title: "Personal Skills Development Planning: From Class to Career",
        status: "Past Event",
        date: "Recent",
        location: "Jamhuuriya University (JUST)",
        category: "Personal Development",
        excerpt: "ALXMDULILLAH! Our seminar 'Personal Skills Development Planning: From Class to Career' with Mohamed Salad Ibrahim was a resounding success. Bridging the gap between academic theory and professional reality.",
        description: `Event Overview
ALXMDULILLAH Our seminar titled **“Personal Skills Development Planning: From Class to Career”** led by **Mohamed Salad Ibrahim** was successfully concluded. This session provided students with a strategic roadmap to transition effectively from the classroom to the professional workforce.

Key Highlights:
* **Strategic Planning:** Learning how to map out personal growth beyond the degree.
* **Skill Alignment:** Identifying the specific technical and soft skills the modern job market demands.
* **Professional Mindset:** Shifting from a student perspective to a career-driven approach.

Our Commitment
Mahadnaq weyn ayaan u diraynaa ardayda **JUTSA** iyo dhammaan ka qaybgalayaasha ka dhigay munaasabadda mid xusuus leh. 
...
**Empowering Minds. Building Future.**`,
    ...
    {
        id: 2,
        title: "Empowering Somali Youth: Entrepreneurial Mindset & Development",
        status: "Past Event",
        date: "Recent",
        location: "Benadir University Innovation Hub",
        category: "Entrepreneurship & Leadership",
        excerpt: "Maanta si rasmi ah ayuu u soo gabagaboobay wajiga labaad ee seminar-ka “Empowering Somali Youth: Entrepreneurial Mindset & Development”.",
        description: `### Event Overview
Maanta si rasmi ah ayuu u soo gabagaboobay wajiga labaad ee seminar-ka **“Empowering Somali Youth: Entrepreneurial Mindset & Development”**.
**Maan Group** oo door hoggaamineed ku leh barnaamijkan, iyadoo kaashanaysa dallada **SEN Somali Youth**, kuna qabsoomay xarunta casriga ah ee **Benadir University Innovation Hub**, ayaa maanta si guul leh u soo xiray maalinta labaad ee madasha kobcinta dhalinyarada Soomaaliyeed 🇸🇴. Madashan ayaa loogu talagalay in lagu diyaariyo jiilka cusub ee hal-abuurada leh, lana siiyo qalabyada garaadka iyo maskaxda ee lagama maarmaanka u ah suuqa ganacsiga ee maanta sii kordhaya.

### Key Focus Areas & Takeaways
Labadii maalmood ee seminar-ka waxaa si qoto dheer loo lafaguray qodobada ugu muhiimsan ee aasaaska u ah guusha ganacsi iyo midda shaqsiyadeed:
* **Xoojinta Maskaxda Ganacsi (Entrepreneurial Mindset):** Sida dhibaatooyinka loogu beddeli karo fursado ganacsi oo waara.
* **Horumarinta Hoggaaminta & Is-hoggaaminta:** Dhisidda awoodaha shaqsiga si uu naftiisa u maamulo kahor inta uusan cid kale hoggaamin.
* **Dhisidda Kalsooni, Wada-shaqeyn & Is-faham:** Barashada muhiimadda xiriirka iyo dhisidda kooxo si dhab ah isku faham kara oo miro dhal sameyn kara.
* **Hal-abuurnimo iyo Fikir Mustaqbal Fog:** Sidee loo naqshadeeyaa layliyo joogto ah oo keenaya xal-u-helid mustaqbal oo hal-abuur xambaarsan.

### Guest Speaker Insights
🎤 **Mohamed Salaad – CEO, Maan Group**
Waxaa madasha si weyn u daadihinayay Maareeyaha Guud ee Maan Group. Ka-qaybgalayaashu waxay madasha ka tabcadeen aqoon xeel-dheer, dhiirrigelin, iyo aragti ballaaran oo salka ku haysa sheekooyin dhab ah iyo xiriiro waaqici ah. Talooyinkii la wadaagay ayaa ahaa kuwo toos u taabanaya dhibaatooyinka ay dhalinyarada ganacsiga bilaabaya ay waajahaan.

...
- **Strategic Innovation**: Deep industry insights paired with creative problem-solving.
- **Human-Centric Design**: A clean, modern website designed for clarity and professional engagement.
- **Dynamic Events**: Integrated platform for seminars, workshops, and institutional growth events.
- **Premium UI**: Built with React, Tailwind CSS, and Framer Motion for a smooth, high-end experience.
...
- **Lucide-Icons**: Beautifully simple, pixel-perfect icon set.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Amen252/Maan-Group.git
   ```
